...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  -- , ((modMask, xK_q), spawn $ "conky-toggle" )
  , ((modMask, xK_f), sendMessage $ Toggle FULL)
  , ((modMask, xK_h), spawn $ "$TERM 'htop task manager' -e htop" )
  , ((modMask, xK_m), spawn $ "pragha" )
  , ((modMask, xK_b), spawn $ "$BROWSER" )
  , ((modMask, xK_c), kill )
  , ((modMask, xK_r), spawn $ "rofi-theme-selector" )
  , ((modMask, xK_v), spawn $ "pavucontrol" )
  , ((modMask, xK_y), spawn $ "polybar-msg cmd toggle" )
  , ((modMask, xK_Backspace), spawn $ "arcolinux-logout" )
  ...
  , ((controlMask .|. mod1Mask , xK_Return ), spawn $ "$TERM")
...
--  , ((0, xF86XK_AudioStop), spawn $ "mpc stop")
  ...
  , ((controlMask, xK_h), sendMessage Shrink)

  -- Expand the master area.
  , ((controlMask, xK_l), sendMessage Expand)
