...
const reactClassComponent = {
    ...
    body: [
        ...
        `export default class ${types_1.SnippetPlaceholders.FileName} extends Component {`,
...
const reactClassExportComponent = {
    ...
    body: [
        ...sharedSnippets_1.reactComponent,
        `export class ${types_1.SnippetPlaceholders.FileName} extends Component {`,
        ...sharedSnippets_1.innerComponentReturn,
        '}',
...
const reactFunctionalExportComponent = {
    ...
    body: [
        ...
        `function ${types_1.SnippetPlaceholders.FileName}() {`,
...
const reactFunctionalComponent = {
    ...
    body: [
        ...sharedSnippets_1.react,
        `export default function ${types_1.SnippetPlaceholders.FileName}() {`,
        ...sharedSnippets_1.innerComponent,
        '}',
        '',
    ],
...
const reactFunctionalComponentWithPropTypes = {
    ...
    body: [
        ...
        '}',
        '',
        `${types_1.SnippetPlaceholders.FileName}.propTypes = {}`,
        ...sharedSnippets_1.exportDefault,
        '',
    ],
...
const reactArrowFunctionExportComponent = {
    ...
    body: [
        ...sharedSnippets_1.react,
        `const ${types_1.SnippetPlaceholders.FileName} = () => {`,
        ...sharedSnippets_1.innerComponent,
        '}',
        ...sharedSnippets_1.exportDefault,
    ],
...
const reactArrowFunctionComponent = {
    ...
    body: [
        ...sharedSnippets_1.react,
        `export const ${types_1.SnippetPlaceholders.FileName} = () => {`,
        ...sharedSnippets_1.innerComponent,
        '}',
        '',
    ],
...
const reactArrowFunctionComponentWithPropTypes = {
    ...
    body: [
        ...sharedSnippets_1.reactPropTypes,
        `const ${types_1.SnippetPlaceholders.FileName} = props => {`,
        ...sharedSnippets_1.innerComponent,
        '}',
        '',
        `${types_1.SnippetPlaceholders.FileName}.propTypes = {}`,
...
const reactClassPureComponent = {
    ...
    body: [
        ...
        `export default class ${types_1.SnippetPlaceholders.FileName} extends PureComponent {`,
        ...sharedSnippets_1.innerComponentReturn,
        '}',
        '',
    ],
...
const reactClassExportPureComponent = {
    ...
    body: [
        ...sharedSnippets_1.reactPureComponent,
        `export class ${types_1.SnippetPlaceholders.FileName} extends PureComponent {`,
        ...sharedSnippets_1.innerComponentReturn,
        '}',
        ...sharedSnippets_1.exportDefault,
    ],
...
const reactFunctionMemoComponent = {
    ...
    body: [
        ...
        '',
        `export default memo(function ${types_1.SnippetPlaceholders.FileName}() {`,
        ...sharedSnippets_1.innerComponent,
        '})',
        '',
    ],
...
const reactFunctionMemoComponentWithPropTypes = {
    ...
    body: [
        ...
        `const ${types_1.SnippetPlaceholders.FileName} = memo(function ${types_1.SnippetPlaceholders.FileName}(props) {`,
        ...sharedSnippets_1.innerComponent,
        '})',
        '',
        `${types_1.SnippetPlaceholders.FileName}.propTypes = {}`,
...
const reactClassComponentPropTypes = {
    ...
    body: [
        ...
        `export default class ${types_1.SnippetPlaceholders.FileName} extends Component {`,
        '  static propTypes = {',
        `    ${types_1.SnippetPlaceholders.SecondTab}: ${types_1.SnippetPlaceholders.ThirdTab}`,
        '  }',
        '',
        ...sharedSnippets_1.innerComponentReturn,
        '}',
...
const reactFunctionalComponentRedux = {
    ...
    body: [
        ...
        `export const ${types_1.SnippetPlaceholders.FileName} = (props) => {`,
        ...sharedSnippets_1.innerComponent,
        '}',
        ...sharedSnippets_1.reduxComponentExport,
    ],
...
const reactFunctionalComponentReduxPropTypes = {
    ...
    body: [
        ...
        '',
        `${types_1.SnippetPlaceholders.FileName}.propTypes = {`,
        `  ${types_1.SnippetPlaceholders.SecondTab}: PropTypes.${types_1.SnippetPlaceholders.ThirdTab}`,
        '}',
        ...sharedSnippets_1.reduxComponentExport,
    ],
