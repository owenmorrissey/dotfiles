...
const importSnippet = {
    ...
    prefix: 'imp',
    body: [
        `import ${types_1.SnippetPlaceholders.SecondTab} from '${types_1.SnippetPlaceholders.FirstTab}'`,
...
const importNoModuleName = {
    ...
    prefix: 'imn',
    body: [
        `import '${types_1.SnippetPlaceholders.FirstTab}'`,
        types_1.SnippetPlaceholders.LastTab,
    ],
};
...
const importEverything = {
    ...
    prefix: 'ime',
    body: [
        `import * as ${types_1.SnippetPlaceholders.SecondTab} from '${types_1.SnippetPlaceholders.FirstTab}'`,
        types_1.SnippetPlaceholders.LastTab,
    ],
};
const importAs = {
    ...
    prefix: 'ima',
    body: [
        `import { ${types_1.SnippetPlaceholders.SecondTab} as ${types_1.SnippetPlaceholders.ThirdTab} } from '${types_1.SnippetPlaceholders.FirstTab}'`,
        types_1.SnippetPlaceholders.LastTab,
    ],
};
exports.default = [
